...
import { toSafeUser } from "../users/user.serializer";
...
function parseDurationToDate(value: string) {
...
async function createTokens(user: SafeUser, context: RequestContext): Promise<AuthTokens> {
...
export const authService = {
  async signup(input: z.infer<typeof signupSchema>, context: RequestContext) {
  ...
  async login(input: z.infer<typeof loginSchema>, context: RequestContext) {
