      ...
      <main>
        ...
        <section className="border-t bg-secondary/35">
          <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
            <h2 className="text-2xl font-semibold">Read the next issue from {post.publication.name}</h2>
            <p className="mt-2 text-sm leading-6 text-muted-foreground">{post.publication.tagline}</p>
