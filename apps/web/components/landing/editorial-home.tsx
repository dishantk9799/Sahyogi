...
import { ArrowRight, MailPlus, PenLine, TrendingUp, type LucideIcon } from "lucide-react";
    ...
    <main>
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <h2 className="mt-2 text-3xl font-semibold">Discover editorial rooms with a point of view</h2>
        </div>
